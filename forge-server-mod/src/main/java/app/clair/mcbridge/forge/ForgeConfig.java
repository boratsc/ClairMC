...
public final class ForgeConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> BRIDGE_URL;
    public static final ForgeConfigSpec.ConfigValue<String> BRIDGE_SERVER_ID;
    public static final ForgeConfigSpec.ConfigValue<String> BRIDGE_SECRET;

    public static final ForgeConfigSpec.IntValue HEARTBEAT_SECONDS;
    public static final ForgeConfigSpec.BooleanValue SEND_JOIN_QUIT;
    public static final ForgeConfigSpec.BooleanValue SEND_DEATHS;
    public static final ForgeConfigSpec.BooleanValue SEND_CHAT;
    public static final ForgeConfigSpec.BooleanValue SEND_ADVANCEMENTS;
    public static final ForgeConfigSpec.BooleanValue HEARTBEAT_PLAYERS_LIST;
    public static final ForgeConfigSpec.BooleanValue HEARTBEAT_TPS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ALLOW_CONSOLE_COMMANDS;
